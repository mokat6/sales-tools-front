...
export const apiClient = {
  ...
  getCompaniesCursor: async (params?: { pageSize?: number; cursor?: string; search?: string }) =>
    swaggerSdk.listCompaninesWithCursor(params?.pageSize, params?.cursor, params?.search),
