  ...
  return (
    <div className="p-2">
      ...
      <button
        ...
        onClick={(e) => {
          console.log(table.getAllColumns()[0].getFilterValue());
          const column = table.getAllColumns()[3];
          column.setFilterValue([1, 34]);
          const x = column.getToggleSortingHandler();
          if (x) x({});

          column.getCanFilter;
          console.log("getFilterValue()  ", table.getColumn("progress")?.getFilterValue());
        }}
      >
        better come equiped
      </button>
